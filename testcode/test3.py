...
MQTT_BROKER_IP = "your.mqtt.broker.address"
...
for name, pin in MODULE_PINS.items():
    modules[name] = OutputDevice(pin, active_high=False, initial_value=False)
...
def publish_data(client, soil_p, water_p, temp_avg, humi_avg):
    ...
    try:
        ...
        publish_topic = "farm/raspi-01/sensor_data"
